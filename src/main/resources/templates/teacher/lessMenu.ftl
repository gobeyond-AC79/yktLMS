<div class="col-md-2" >
    <ul class="nav nav-pills nav-stacked" id="nav">
        ...
        <li ><a href="">上课签到<sapn class="glyphicon glyphicon-pushpin pull-right" /></a></li>
        <li role="presentation"><a href="">点名提问<sapn class="glyphicon glyphicon-ok pull-right" /></a></li>
    </ul>
</div>
